...
// Load shortocdes
require(SMART_TEMPLATE_DIRECTORY .SMART_LIB_DIRECTORY. 'extend/class-shortcodes.php');
// Load external function
require(SMART_TEMPLATE_DIRECTORY .SMART_LIB_DIRECTORY. 'extend/class-extend-project-admin.php');
// Load extend overlall class
require(SMART_TEMPLATE_DIRECTORY .SMART_LIB_DIRECTORY. 'extend/extend-utils.php');
// Load extend template tags
require(SMART_TEMPLATE_DIRECTORY .SMART_LIB_DIRECTORY. 'extend/template-tags-extend.php');
...
//require(SMART_TEMPLATE_DIRECTORY . '/inc/plugin.php');
