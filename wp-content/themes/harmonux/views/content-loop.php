	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<!-- .entry-header -->
				...
				if ('' != get_the_post_thumbnail()) {
					?>
					<div class="smartlib-thumbnail-outer"><a href="<?php the_permalink(); ?>"><?php smartlib_get_format_ico($post_format) ?><?php the_post_thumbnail('wide-image'); ?></a><?php smartlib_category_line(); ?></div>
